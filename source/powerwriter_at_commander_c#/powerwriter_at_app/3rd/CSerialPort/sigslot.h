...
#if defined(SIGSLOT_PURE_ISO) || (!defined(_MSC_VER) && !defined(__NT__)  && !defined(__GNUG__) && !defined(SIGSLOT_USE_POSIX_THREADS))
#	define _SIGSLOT_SINGLE_THREADED
#elif defined(_MSC_VER) || defined(__NT__)
...
namespace sigslot {
	...
	template<class mt_policy> class has_slots;	//lock_block to has_slots
	//模板抽象
	template<class mt_policy>
	...
	{
	private:
		typedef typename std::set<_signal_base<mt_policy> *> sender_set;	//结合列表
		typedef typename sender_set::const_iterator const_iterator;			//集合列表常量迭代
