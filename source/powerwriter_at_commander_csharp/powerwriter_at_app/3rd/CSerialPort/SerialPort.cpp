...
CSerialPort::CSerialPort()
{
	...
	((CSERIALPORTBASE *)p_serialPortBase)->disconnectCallback.connect(this, &CSerialPort::onDisconnectCallback);
...
CSerialPort::~CSerialPort()
{
	...
	((CSERIALPORTBASE *)p_serialPortBase)->disconnectCallback.disconnect_all();
...
int itas109::CSerialPort::readAllData(std::vector<char> & data)
{
    if (p_serialPortBase)
    {
...
{
	OnReadReadyCallBack._emit();
}

void itas109::CSerialPort::onDisconnectCallback()
{
	OnDisconnectCallBack._emit();
}